      ...
      {!gameState.gameWon && !gameState.gameFailed && (
        <>
          <img 
            ...
            alt="Door 1"
            className="absolute top-1/2 left-8 transform -translate-y-1/2 w-48 h-auto cursor-pointer transition-all duration-200 hover:brightness-110 animate-bounce"
            style={{
              animation: 'enchanted-float 3s ease-in-out infinite, enchanted-pulse 2s ease-in-out infinite'
            }}
          ...
          <img 
            ...
            alt="Door 2"
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-full w-48 h-auto cursor-pointer transition-all duration-200 hover:brightness-110 animate-bounce"
            style={{
              animation: 'enchanted-float 2.5s ease-in-out infinite, enchanted-pulse 2.5s ease-in-out infinite',
              animationDelay: '0.5s'
            }}
          ...
          <img 
            ...
            alt="Door 3"
            className="absolute top-1/2 right-8 transform -translate-y-1/2 w-48 h-auto cursor-pointer transition-all duration-200 hover:brightness-110 animate-bounce"
            style={{
              animation: 'enchanted-float 3.5s ease-in-out infinite, enchanted-pulse 3s ease-in-out infinite',
              animationDelay: '1s'
            }}
