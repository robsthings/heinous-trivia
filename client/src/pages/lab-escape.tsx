      ...
      {!gameState.gameWon && !gameState.gameFailed && (
        <>
          <img 
            ...
            alt="Door 1"
            className="absolute top-1/2 left-8 transform -translate-y-full w-48 h-auto cursor-pointer hover:animate-pulse transition-all duration-200 hover:brightness-110"
          ...
          <img 
            ...
            alt="Door 3"
            className="absolute top-1/2 right-8 transform -translate-y-full w-48 h-auto cursor-pointer hover:animate-pulse transition-all duration-200 hover:brightness-110"
