  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-indigo-900 to-black text-white flex flex-col items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        {gamePhase === "intro" && (
          <div className="text-center bg-black/50 backdrop-blur-sm p-8 rounded-lg border border-blue-500/30">
            <div className="mb-6">
        ...
        {(gamePhase === "studying" || gamePhase === "inputting") && (
          <div>
            ...
            {/* Phantom Message */}
            <div className="mb-6 text-center bg-blue-900/20 rounded-lg p-4 border border-blue-500/30">
            ...
            {gamePhase === "studying" && currentPattern && (
              <div className="mb-6">
                <h3 className="text-xl font-bold text-center mb-4 text-blue-400">Study This Pattern</h3>
            ...
            {gamePhase === "inputting" && currentPattern && (
              <div>
                <h3 className="text-xl font-bold text-center mb-4 text-blue-400">Recreate the Pattern</h3>
                
                {/* User Input Display */}
                <div className="mb-6 flex justify-center gap-3 flex-wrap bg-gray-800/50 rounded-lg p-6 border border-gray-600 min-h-[100px]">
