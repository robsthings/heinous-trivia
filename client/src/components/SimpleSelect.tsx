  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="w-full  border border-gray-600 rounded px-3 py-2 text-left text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500" style={{backgroundColor: "#1f2937"}}
      >
