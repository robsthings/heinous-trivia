...
## Changelog
- June 17, 2025: **ENHANCED CURSE CRAFTING WITH INGREDIENT-BASED GENERATION** - Updated curse system to use actual selected ingredients in creative templates ("May every shoelace they tie turn into Easther of Wood Rossen"), added Eater Google Font in toxic green for dramatic title styling, implemented scroll reveal animation with PowerPoint-style effects, complete parchment spell display with curse text, target, and side effects
